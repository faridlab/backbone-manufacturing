-- Migration: Create repair_tags table
...
CREATE INDEX IF NOT EXISTS idx_repair_tags_metadata_created_at ON manufacturing.repair_tags ((metadata->>'created_at'));
CREATE INDEX IF NOT EXISTS idx_repair_tags_metadata_updated_at ON manufacturing.repair_tags ((metadata->>'updated_at'));
