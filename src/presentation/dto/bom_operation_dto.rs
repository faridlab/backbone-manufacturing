//! BomOperation DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new BomOperation
///
...
/// Request DTO for full update of a BomOperation
///
...
/// Request DTO for partial update of a BomOperation
///
...
pub struct PatchBomOperationDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "time_in_mins")]
    pub time_in_mins: Option<Decimal>,
...
/// Response DTO for BomOperation entity
///
...
/// Paginated list response for BomOperation entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct BomOperationListResponseDto {
    /// List of items
    pub items: Vec<BomOperationResponseDto>,
...
impl BomOperationListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<BomOperationResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<BomOperation> for BomOperationResponseDto {
    fn from(entity: BomOperation) -> Self {
        Self {
            ...
            time_in_mins: entity.time_in_mins,
...
impl From<BomOperation> for BomOperationSummaryDto {
    fn from(entity: BomOperation) -> Self {
...
impl From<CreateBomOperationDto> for BomOperation {
...
impl From<&BomOperation> for BomOperationResponseDto {
    fn from(entity: &BomOperation) -> Self {
        Self {
            ...
            time_in_mins: entity.time_in_mins.clone(),
...
impl backbone_core::FromCreateDto<CreateBomOperationDto> for BomOperation {
    fn from_create_dto(dto: CreateBomOperationDto) -> backbone_core::ServiceResult<Self> {
        Ok(BomOperation::from(dto))
    }
}
...
impl backbone_core::ApplyUpdateDto<UpdateBomOperationDto> for BomOperation {
    fn apply_update(mut self, dto: UpdateBomOperationDto) -> backbone_core::ServiceResult<Self> {
        ...
        self.time_in_mins = dto.time_in_mins;
