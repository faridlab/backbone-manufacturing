//! Workstation DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new Workstation
///
...
/// Request DTO for full update of a Workstation
///
...
/// Request DTO for partial update of a Workstation
///
...
/// Response DTO for Workstation entity
///
...
/// Paginated list response for Workstation entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct WorkstationListResponseDto {
    /// List of items
    pub items: Vec<WorkstationResponseDto>,
...
impl WorkstationListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<WorkstationResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Workstation> for WorkstationResponseDto {
...
impl From<Workstation> for WorkstationSummaryDto {
    fn from(entity: Workstation) -> Self {
...
impl From<CreateWorkstationDto> for Workstation {
...
impl backbone_core::FromCreateDto<CreateWorkstationDto> for Workstation {
    fn from_create_dto(dto: CreateWorkstationDto) -> backbone_core::ServiceResult<Self> {
        Ok(Workstation::from(dto))
    }
}
