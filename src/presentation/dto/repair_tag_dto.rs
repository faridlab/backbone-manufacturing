//! RepairTag DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new RepairTag
///
...
/// Request DTO for full update of a RepairTag
///
...
/// Request DTO for partial update of a RepairTag
///
...
/// Response DTO for RepairTag entity
///
...
/// Paginated list response for RepairTag entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct RepairTagListResponseDto {
    /// List of items
    pub items: Vec<RepairTagResponseDto>,
...
impl RepairTagListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<RepairTagResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<RepairTag> for RepairTagResponseDto {
...
impl From<RepairTag> for RepairTagSummaryDto {
    fn from(entity: RepairTag) -> Self {
...
impl From<CreateRepairTagDto> for RepairTag {
...
impl backbone_core::FromCreateDto<CreateRepairTagDto> for RepairTag {
    fn from_create_dto(dto: CreateRepairTagDto) -> backbone_core::ServiceResult<Self> {
        Ok(RepairTag::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to RepairTag here.
