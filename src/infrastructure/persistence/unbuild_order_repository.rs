...
//!
//! Thin newtype over `backbone_orm::GenericCrudRepository<UnbuildOrder, backbone_orm::SoftDelete>`.
...
backbone_core::impl_crud_repository!(UnbuildOrderRepository, UnbuildOrder, soft_delete);
