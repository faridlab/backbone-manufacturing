//! Domain policy for Operation aggregate
//!
...
/// Domain policy for Operation — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Operation>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OperationDomainPolicy = PermitAllPolicy<Operation>;
