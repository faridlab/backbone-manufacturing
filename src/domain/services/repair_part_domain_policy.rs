//! Domain policy for RepairPart aggregate
//!
...
/// Domain policy for RepairPart — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RepairPart>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RepairPartDomainPolicy = PermitAllPolicy<RepairPart>;
