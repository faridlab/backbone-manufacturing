//! Domain policy for WorkstationProductivity aggregate
//!
...
/// Domain policy for WorkstationProductivity — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<WorkstationProductivity>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type WorkstationProductivityDomainPolicy = PermitAllPolicy<WorkstationProductivity>;
