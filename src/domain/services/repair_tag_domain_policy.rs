//! Domain policy for RepairTag aggregate
//!
...
/// Domain policy for RepairTag — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RepairTag>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RepairTagDomainPolicy = PermitAllPolicy<RepairTag>;
