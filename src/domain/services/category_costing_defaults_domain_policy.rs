//! Domain policy for CategoryCostingDefaults aggregate
//!
...
/// Domain policy for CategoryCostingDefaults — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<CategoryCostingDefaults>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type CategoryCostingDefaultsDomainPolicy = PermitAllPolicy<CategoryCostingDefaults>;
