//! Domain policy for RepairOrder aggregate
//!
...
/// Domain policy for RepairOrder — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RepairOrder>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RepairOrderDomainPolicy = PermitAllPolicy<RepairOrder>;
