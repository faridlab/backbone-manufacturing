//! Domain policy for SubcontractMoLink aggregate
//!
...
/// Domain policy for SubcontractMoLink — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SubcontractMoLink>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SubcontractMoLinkDomainPolicy = PermitAllPolicy<SubcontractMoLink>;
