//! Domain policy for WorkstationLoss aggregate
//!
...
/// Domain policy for WorkstationLoss — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<WorkstationLoss>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type WorkstationLossDomainPolicy = PermitAllPolicy<WorkstationLoss>;
