//! Specifications for UnbuildOrder aggregate
//!
...
// Each predicate implements `Specification<UnbuildOrder>` and can be combined
...
//
// pub struct ActiveUnbuildOrderSpec;
// impl Specification<UnbuildOrder> for ActiveUnbuildOrderSpec {
//     fn is_satisfied_by(&self, e: &UnbuildOrder) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
