//! Specifications for SubcontractMoLink aggregate
//!
...
// Each predicate implements `Specification<SubcontractMoLink>` and can be combined
...
//
// pub struct ActiveSubcontractMoLinkSpec;
// impl Specification<SubcontractMoLink> for ActiveSubcontractMoLinkSpec {
//     fn is_satisfied_by(&self, e: &SubcontractMoLink) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
