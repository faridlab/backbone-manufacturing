//! Specifications for WorkOrderItem aggregate
//!
...
// Each predicate implements `Specification<WorkOrderItem>` and can be combined
...
//
// pub struct ActiveWorkOrderItemSpec;
// impl Specification<WorkOrderItem> for ActiveWorkOrderItemSpec {
//     fn is_satisfied_by(&self, e: &WorkOrderItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
