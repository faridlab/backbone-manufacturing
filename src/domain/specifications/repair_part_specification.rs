//! Specifications for RepairPart aggregate
//!
...
// Each predicate implements `Specification<RepairPart>` and can be combined
...
//
// pub struct ActiveRepairPartSpec;
// impl Specification<RepairPart> for ActiveRepairPartSpec {
//     fn is_satisfied_by(&self, e: &RepairPart) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
