//! Specifications for JobCard aggregate
//!
...
// Each predicate implements `Specification<JobCard>` and can be combined
...
//
// pub struct ActiveJobCardSpec;
// impl Specification<JobCard> for ActiveJobCardSpec {
//     fn is_satisfied_by(&self, e: &JobCard) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
