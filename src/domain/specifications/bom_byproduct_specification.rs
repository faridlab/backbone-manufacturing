//! Specifications for BomByproduct aggregate
//!
...
// Each predicate implements `Specification<BomByproduct>` and can be combined
...
//
// pub struct ActiveBomByproductSpec;
// impl Specification<BomByproduct> for ActiveBomByproductSpec {
//     fn is_satisfied_by(&self, e: &BomByproduct) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
