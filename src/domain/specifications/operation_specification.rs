//! Specifications for Operation aggregate
//!
...
// Each predicate implements `Specification<Operation>` and can be combined
...
//
// pub struct ActiveOperationSpec;
// impl Specification<Operation> for ActiveOperationSpec {
//     fn is_satisfied_by(&self, e: &Operation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
