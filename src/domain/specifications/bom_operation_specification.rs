//! Specifications for BomOperation aggregate
//!
...
// Each predicate implements `Specification<BomOperation>` and can be combined
...
//
// pub struct ActiveBomOperationSpec;
// impl Specification<BomOperation> for ActiveBomOperationSpec {
//     fn is_satisfied_by(&self, e: &BomOperation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
