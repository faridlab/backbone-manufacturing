//! Specifications for BomSubcontractor aggregate
//!
...
// Each predicate implements `Specification<BomSubcontractor>` and can be combined
...
//
// pub struct ActiveBomSubcontractorSpec;
// impl Specification<BomSubcontractor> for ActiveBomSubcontractorSpec {
//     fn is_satisfied_by(&self, e: &BomSubcontractor) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
