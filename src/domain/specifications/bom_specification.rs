//! Specifications for Bom aggregate
//!
...
// Each predicate implements `Specification<Bom>` and can be combined
...
//
// pub struct ActiveBomSpec;
// impl Specification<Bom> for ActiveBomSpec {
//     fn is_satisfied_by(&self, e: &Bom) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
