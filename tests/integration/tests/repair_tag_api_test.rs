//! RepairTag API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the RepairTag CRUD API endpoints.
...
// ============================================================================
// REPAIRTAG TEST DATA GENERATOR
// ============================================================================

/// Test data generator for RepairTag
pub struct RepairTagTestData;

impl TestDataGenerator for RepairTagTestData {
...
/// RepairTag API test suite
pub struct RepairTagApiTest {
    inner: GenericCrudTest<RepairTagTestData>,
}

impl RepairTagApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/repair_tags", "RepairTag");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, RepairTagTestData),
        }
    }
...
impl Default for RepairTagApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
// <<< CUSTOM TESTS START >>>
// Add RepairTag specific tests here
// <<< CUSTOM TESTS END >>>
